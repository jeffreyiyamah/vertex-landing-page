    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-black to-zinc-900 text-white">
      ...
      <section className="container mx-auto px-4 py-20 md:py-32 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-zinc-400 mb-6">Intelligence that grows smarter with every incident</p>
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-2" className="border-zinc-800">
              ...
              <AccordionContent className="text-zinc-400">
                ...
                SentinelOne, CarbonBlack), and log sources (CloudTrail, Cloudflare, Okta, etc). We also offer an API for
                custom integrations.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4" className="border-zinc-800">
              ...
              <AccordionContent className="text-zinc-400">
                ...
                AI-powered analysis provides enterprise-grade security insights without requiring a large security team
            ...
            <AccordionItem value="item-5" className="border-zinc-800">
              ...
              <AccordionContent className="text-zinc-400">
                Vertex offers simple, transparent pricing based on the volume of data analyzed. We provide a Pilot plan
                to get started, followed by Starter and Growth plans as your needs expand. Visit our{" "}
