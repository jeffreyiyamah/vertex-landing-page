        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-zinc-400">
                An incident is any security event that Vertex analyzes and provides insights on. This could be a failed
                login attempt, unusual API activity, or any other security-related event that requires investigation.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-zinc-400">
                If you exceed your monthly incident limit, you'll be notified and have the option to upgrade to a higher
                tier or purchase additional incidents at a per-incident rate.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-zinc-400">
                No long-term contracts required. All plans are month-to-month and you can cancel anytime. The Pilot plan
